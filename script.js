...
let weather = {
  ...
  weekly: function (data) {
    ...
    fetch(
      `https://api.openweathermap.org/data/2.5/onecall?lat=${data.coord.lat}&lon=${data.coord.lon}&units=metric&exclude=minutely,hourly&appid=246ddc204e774299abd36645854b69fc`
    )
      .then((res) => res.json())
      .then((newdata) => this.displayweekly(newdata));
  },
